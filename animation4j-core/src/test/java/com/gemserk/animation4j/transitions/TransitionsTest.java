...
public class TransitionsTest {
	...
	public void shouldFailToInferConverterFromStartValueIfConverterNotRegistered() {
		...
		Transitions.mutableTransition(new Vector2f(100f, 100f)).build();
	}
	...
	public void shouldInferConverterFromStartValueIfConverterRegistered() {
		...
		Transition<Vector2f> transition = Transitions.mutableTransition(new Vector2f(100f, 100f)).build();
	...
	public void testCreateTransitionThroughTransitionBuilderUsingFloatArrays() {
		...
		Transition<Vector2f> transition = Transitions.mutableTransition(v, vector2fConverter) //
				.start(20f, 20f) //
				.end(0.5f, 100f, 100f) //
				.build();

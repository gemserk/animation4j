...
public interface TypeConverter<T> {
	 ...
	 * @param object - The object from where to get the values to fulfill the float array.
	 * @param x - The float array to copy the values of the object. If null it will create a new float array.
	 ...
	 * @param object - The object which the float array values will be copied to. If null or object immutable, it will create a new object.
	 * @param x - The float array to get the values to fulfill the object. 

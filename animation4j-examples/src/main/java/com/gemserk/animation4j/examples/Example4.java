...
public class Example4 extends Java2dDesktopApplication {
	...
	static class ExampleInternalGame implements Java2dGame {
		...
		public void init() {
			...
			buttons.add(new Button() {
				{
					...
					color = interpolatedProperty(transition(new Color(1f, 1f, 1f, 1f), 0.005f));
					glowColor = interpolatedProperty(transition(new Color(1f, 0f, 0f, 0f), 0.002f));
			...
			backgroundColor = transition(new Color(0.4f, 0.4f, 0.4f, 0f), 0.001f);
